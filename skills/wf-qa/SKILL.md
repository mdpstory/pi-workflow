...
4. **If you discover test-relevant details** (mock patterns, test helpers, fixture locations), append to `.workflow/context.md` — helps Documenter and future runs. Cite `path:startLine-endLine`, not just the filename.
