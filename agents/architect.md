...
tools: read, bash, write, edit, codegraph_search, codegraph_explore, codegraph_files, codegraph_node, wf_knowledge_get, wf_knowledge_put, wf_clr_open, wf_msg_post, wf_msg_poll
---
